    ...
    <div x-data="{ isAdmin: false }">
        <div x-show="isAdmin">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8" x-data="bookingComponent()"
                ...
                <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8" x-data="rescheduleComponent()"
                    x-init="fetchReschedules()">
                    <div class="flex items-center justify-between mb-4">
                        <h5 class="text-xl font-bold leading-none text-gray-900">Ubah Booking</h5>
                        <a href="/admin/reschedule-booking" class="text-sm font-medium text-blue-600 hover:underline">
                            Lihat semua
                        </a>
                    </div>
                    <div class="flow-root">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="flex-1 min-w-0 ms-4">
                                            ...
                                            <div class="text-xs text-gray-500">
                                                ...
                                                <p
                                                    x-text="`${reschedule.old_schedule.date} | ${reschedule.old_schedule.session}`">
                                                </p>
                                                <p class="font-semibold mt-1">Jadwal Baru:</p>
                                                <p
                                                    x-text="`${reschedule.new_schedule.date} | ${reschedule.new_schedule.session}`">
                                                </p>
                                            </div>
                                        </div>
                ...
                <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8" x-data="cancelBookingComponent()"
                    x-init="fetchCancelRequests()">
                    <div class="flex items-center justify-between mb-4">
                        <h5 class="text-xl font-bold leading-none text-gray-900">Pembatalan Booking</h5>
                        <a href="/admin/cancel" class="text-sm font-medium text-blue-600 hover:underline">
                            Lihat semua
                        </a>
                    </div>
                    <div class="flow-root">
