        ...
        <div class=" grid grid-cols-2 gap-10"
            x-data="{
                ...
                methods: {
                    dana: {
                        name: 'Dana',
                        image: '{{ asset('assets/images/eWallet/dana.svg') }}',
                        number: '8823001301230'
                        },
                    gopay: {
                        name: 'Gopay',
                        image: '{{ asset('assets/images/eWallet/gopay.svg') }}',
                        number: '8823001304567'
                        },
                    shopeepay: {
                        name: 'Shopee Pay',
                        image: '{{ asset('assets/images/eWallet/shopeePay.svg') }}',
                        number: '8823001308910'
                        },
                    ovo: {
                        name: 'OVO',
                        image: '{{ asset('assets/images/eWallet/ovo.svg') }}',
                        number: '8823001301122'
                        },
                    va: {
                        name: 'Transfer Virtual Account',
                        image: '{{ asset('assets/images/eWallet/virtualAccount.svg') }}',
                ...
                <div>
                    ...
                    <div x-show="dropDown == 'down'" x-transition class="space-y-2">
                        <template x-for="(method, key) in methods" :key="key">
                            <div @click="selectedMethod = key; dropDown = 'up'" class="cursor-pointer flex justify-between shadow bg-white rounded-lg items-center p-2.5 text-base hover:bg-gray-100 transition">
            ...
            <div class=" space-y-4">
                <div class="border border-gray-600 p-5 rounded-xl">
                    <div class="flex flex-col items-center justify-center space-y-2">
                        <img class="rounded-xl shadow h-[100px]" :src="methods[selectedMethod].image"
                            alt="">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-between">
                                <p class="font-bold text-2xl">Rp 1.000.000</p>
                                <a href="#" class="flex items-center font-bold text-xl text-red-600">Salin
                                    <svg class="ml-1" width="15" height="19" viewBox="0 0 15 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11 1H5C2.79086 1 1 2.79086 1 5V13" stroke="#222222"/>
                                        <path d="M4.5 9.5C4.5 8.31558 4.50074 7.46912 4.57435 6.81625C4.64681 6.17346 4.78457 5.78051 5.01662 5.4781C5.14962 5.30477 5.30477 5.14962 5.4781 5.01662C5.78051 4.78457 6.17346 4.64681 6.81625 4.57435C7.46912 4.50074 8.31558 4.5 9.5 4.5C10.6844 4.5 11.5309 4.50074 12.1837 4.57435C12.8265 4.64681 13.2195 4.78457 13.5219 5.01662C13.6952 5.14962 13.8504 5.30477 13.9834 5.4781C14.2154 5.78051 14.3532 6.17346 14.4257 6.81625C14.4993 7.46912 14.5 8.31558 14.5 9.5V13.5C14.5 14.6844 14.4993 15.5309 14.4257 16.1837C14.3532 16.8265 14.2154 17.2195 13.9834 17.5219C13.8504 17.6952 13.6952 17.8504 13.5219 17.9834C13.2195 18.2154 12.8265 18.3532 12.1837 18.4257C11.5309 18.4993 10.6844 18.5 9.5 18.5C8.31558 18.5 7.46912 18.4993 6.81625 18.4257C6.17346 18.3532 5.78051 18.2154 5.4781 17.9834C5.30477 17.8504 5.14962 17.6952 5.01662 17.5219C4.78457 17.2195 4.64681 16.8265 4.57435 16.1837C4.50074 15.5309 4.5 14.6844 4.5 13.5V9.5Z" stroke="#222222"/>
                    ...
                    <hr class="h-px my-4 bg-gray-400 border-0 dark:bg-gray-700">
                    <div class="space-y-2">
                        <p class="text-xs">· <span class="font-bold">Penting</span>: Transfer Virtual Account hanya bisa dilakukan dari bank yang kamu pilih</p>
                        <p class="text-xs">· Transaksi kamu baru akan diteruskan ke penjual setelah pembayaran berhasil diverifikasi</p>
                    </div>
                </div>
